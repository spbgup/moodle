...
$linkyes ='/activeall.php?linktype='.$linktype.'&linkid='.$linkid.'&active=1';
...
}else
{
    ...
    // спросим об удалении
    $DOF->modlib('widgets')->notice_yesno($DOF->get_string('confirmation_active_plan_all','plans'), $DOF->url_im('plans',$linkyes,$addvars),
