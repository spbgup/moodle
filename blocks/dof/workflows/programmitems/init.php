...
class dof_workflow_programmitems implements dof_workflow
{
    ...
    {
        return array(array('plugintype'=>'storage','plugincode'=>$this->get_storage(),'eventcode'=>'insert'));
    }
    /** 
    ...
    {
		return array('active'  => $this->dof->get_string('status:active', 'programmitems',NULL,'workflow'),
					 'suspend' => $this->dof->get_string('status:suspend', 'programmitems',NULL,'workflow'),
					 'deleted' => $this->dof->get_string('status:deleted', 'programmitems',NULL,'workflow'));
    }
    /** 
