...
class dof_storage_workplaces extends dof_storage implements dof_storage_config_interface
{
    ...
    /**
     * Обработчик доавбления должности в справочник "workplaces"
     * @param int $personid - id персоны
     * @param int $orgid - id организации
     * @param string $post - название должности
     * @return bool true/false - успешное/провальное добавление в базу
     */
    public function handle_workplace($personid, $orgid=0, $post='')
    {
            		...
            		'id,organizationid') )
        {
            ...
            {// просто обновим запись
                $obj = new stdClass();
                $obj->post = mb_convert_case($post, MB_CASE_TITLE, "UTF-8");
