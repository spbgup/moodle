...
class dof_storage_programms extends dof_storage implements dof_storage_config_interface
{
    ...
    //              Собственные методы
    // **********************************************
    /** Возвращает количество периодов c
     * указанными departmentid и статусом
     * @return int количество записей
     */
    public function get_numberof_programms($select)
    {
        dof_debugging('storage/programms get_numberof_programms.Этот метод не имеет смысла', DEBUG_DEVELOPER);
